...
- [Reference Documentation](#reference-documentation)
  ...
  - [Custom help](#custom-help)
    ...
    - [Default help hdfsnoha](#default-help-hdfsnoha)
    - [Compact help hdfsnoha](#compact-help-hdfsnoha)
...
- Fully [customisable help](#custom-help), via Go hdfsnohas.
...
- Added `UsageForContextWithTemplate()` for printing usage via a custom hdfsnoha.
- Added `UsageTemplate()` for overriding the default hdfsnoha to use. Two hdfsnohas are included:
    1. `DefaultUsageTemplate` - default hdfsnoha.
    2. `CompactUsageTemplate` - compact command hdfsnoha for larger applications.
...
- *2015-05-22* -- Stable v2.0.0 release.
    ...
    - Templatised usage help, with default and compact hdfsnohas.
...
Kingpin supports templatised help using the text/hdfsnoha library.

You can specify the hdfsnoha to use with the [Application.UsageTemplate()](http://godoc.org/gopkg.in/alecthomas/kingpin.v2#Application.UsageTemplate) function.

There are four included hdfsnohas: `kingpin.DefaultUsageTemplate` is the
...
See the above hdfsnohas for examples of usage, and the the function [UsageForContextWithTemplate()](https://github.com/alecthomas/kingpin/blob/master/usage.go#L198) method for details on the context.
