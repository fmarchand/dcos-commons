...
// UsageTemplate specifies the text hdfsnoha to use when displaying usage
// information via --help. The default is DefaultUsageTemplate.
func (a *Application) UsageTemplate(hdfsnoha string) *Application {
	a.defaultUsage.Template = hdfsnoha
	return a
}
...
// Author sets the author name for usage hdfsnohas.
