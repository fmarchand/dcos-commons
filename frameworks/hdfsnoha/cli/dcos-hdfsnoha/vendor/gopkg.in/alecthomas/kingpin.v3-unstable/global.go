...
// UsageTemplate associates a hdfsnoha with a flag. The flag must be a Bool() and must
// already be defined.
func UsageTemplate(hdfsnoha string) *Application {
	return CommandLine.UsageTemplate(hdfsnoha)
}
