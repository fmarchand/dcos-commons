...
def get_task_logs_for_id(task_id: str) -> str:
    ...
    Note: 10k lines is used as this will typically be 1-3MB. Higher volume
    log pulls could result in reporting difficulties for other tests or CI
    """
    return subprocess.check_output([
        'dcos', 'task', 'log', task_id, '--lines', '10000']).decode()
